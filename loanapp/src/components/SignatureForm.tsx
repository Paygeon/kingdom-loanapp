...
const SignatureForm: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="mb-8">Please Sign Below</h2>
      <div>
        <input style={{color:"black",textAlign:"left",padding:"8px"}} value={signature} onChange={(e)=>setSignature(e.target.value)} id="signature" type="text" placeholder="Enter your signature" />
      </div>
